          ...
          <li class="nav-item mr-3 mr-lg-0 dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
				...
				<?php if(is_user_logged_in()) { ?>
					<li><a class="dropdown-item" href="<?php echo esc_url(site_url('/wp-admin/post-new.php?post_type=mina-recept')); ?>">Skapa eget recept</a></li>
					<li><a class="dropdown-item" href="<?php echo esc_url(site_url('/wp-admin/edit.php?post_type=mina-recept')); ?>">Mina recept</a></li>
