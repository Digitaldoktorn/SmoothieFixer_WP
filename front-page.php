...
<div class="container">
          ...
          <div class="d-flex align-items-center justify-content-center">
            <div class="text-white col-lg-8 ml-lg-5 mt-4">
              ...
              <?php if(is_user_logged_in()) { ?>
                <a class="mt-3 mr-2 btn btn-outline-light" href="<?php echo site_url('/wp-admin/post-new.php?post_type=mina-recept'); ?>" role="button">Skapa ditt eget smoothie-recept</a>
              <?php } ?>
            </div>
          </div>
        </div>
      ...
      <section class="row justify-content-center mt-3 py-5 bg-white">
        <div class="col-lg-5 col-md-12 pl-4 mb-4 mb-md-0">
          ...
          <br>
          <a class="btn btn-info mb-4" href="<?php echo site_url('/recept'); ?>">Se utvalda recept</a>
        </div>
        <div class="col-lg-6">
